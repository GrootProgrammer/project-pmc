...
# States
class State(object):
	__slots__ = ("var0", "var1", "var2", "var3", "var4", "var5")
	...
	def __eq__(self, other):
		return isinstance(other, self.__class__) and self.var0 == other.var0 and self.var1 == other.var1 and self.var2 == other.var2 and self.var3 == other.var3 and self.var4 == other.var4 and self.var5 == other.var5
...
class autAutomaton(object):
	...
	def __init__(self, network: Network):
		...
		self.transition_counts = [9]
		self.transition_labels = [[0, 0, 0, 0, 0, 0, 0, 0, 0]]
		self.branch_counts = [[1, 1, 1, 1, 2, 2, 2, 2, 2]]
	...
	def get_guard_value(self, state: State, transition: int) -> bool:
		...
		if location == 0:
			if transition == 0:
				...
				return ((state.var5 == 3) and (state.var0 == 0))
			elif transition == 2:
				return ((state.var5 == 4) and (state.var1 == 0))
			elif transition == 3:
				return ((state.var5 == 5) and (state.var2 == 0))
			elif transition == 4:
				return (((state.var5 == 0) and (state.var4 == 0)) or ((state.var5 == 3) and (state.var4 == 0)))
			elif transition == 5:
				return ((state.var5 == 0) and (state.var4 == 0))
			elif transition == 6:
				return (((state.var5 == 1) and (state.var4 == 0)) or ((state.var5 == 4) and (state.var4 == 0)))
			elif transition == 7:
				return (((state.var5 == 1) and (state.var4 == 0)) or ((state.var5 == 5) and (state.var4 == 0)))
			elif transition == 8:
				return ((state.var5 == 3) and (state.var4 == 0))
			else:
				raise IndexError
		else:
			raise IndexError
...
class Network(object):
	...
	def __init__(self):
		...
		self.variables = [
			...
			VariableInfo("var5", None, "int", 0, 6)
		]
