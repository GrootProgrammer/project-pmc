...
# States
class State(object):
	__slots__ = ("counter", "pc1", "coin1", "pc2", "coin2", "pc3", "coin3", "pc4", "coin4", "process1_location", "process2_location", "process3_location", "process4_location")
	...
	def get_variable_value(self, variable: int):
		if variable == 0:
			...
			return self.process3_location
		elif variable == 12:
			return self.process4_location
	...
	def copy_to(self, other: State):
		...
		other.process3_location = self.process3_location
		other.process4_location = self.process4_location
	
	def __eq__(self, other):
		return isinstance(other, self.__class__) and self.counter == other.counter and self.pc1 == other.pc1 and self.coin1 == other.coin1 and self.pc2 == other.pc2 and self.coin2 == other.coin2 and self.pc3 == other.pc3 and self.coin3 == other.coin3 and self.pc4 == other.pc4 and self.coin4 == other.coin4 and self.process1_location == other.process1_location and self.process2_location == other.process2_location and self.process3_location == other.process3_location and self.process4_location == other.process4_location
	...
	def __hash__(self):
		...
		result = (((101 * result) & 0xFFFFFFFF) + hash(self.process3_location)) & 0xFFFFFFFF
		result = (((101 * result) & 0xFFFFFFFF) + hash(self.process4_location)) & 0xFFFFFFFF
		return result
	...
	def __str__(self):
		...
		result += ", process3_location = " + str(self.process3_location)
		result += ", process4_location = " + str(self.process4_location)
		result += ")"
		return result
...
class process1Automaton(object):
	...
	def get_transient_value(self, state: State, transient_variable: str):
		...
		if location == 0:
			...
			if transient_variable == "finished":
				return (((state.pc4 == 3) and (state.pc2 == 3)) and (state.pc3 == 3))
			elif transient_variable == "all_coins_equal_0":
				return (((state.coin4 == 0) and (state.coin2 == 0)) and ((state.coin3 == 0) and (state.coin1 == 0)))
			elif transient_variable == "all_coins_equal_1":
				return (((state.coin4 == 1) and (state.coin2 == 1)) and ((state.coin3 == 1) and (state.coin1 == 1)))
	...
	def get_guard_value(self, state: State, transition: int) -> bool:
		...
		if location == 0:
			...
			if transition == 0:
				...
				return ((state.coin1 == 1) and (state.counter < 24))
			elif transition == 2:
				return True
			else:
				raise IndexError
			...
			if transition == 0:
				...
				return ((state.counter > 4) and (state.counter < 20))
			elif transition == 3:
				return True
			else:
				raise IndexError
	...
	def get_guard_value(self, state: State, transition: int) -> bool:
		...
		if location == 0:
			...
			if transition == 0:
				...
				return ((state.coin2 == 1) and (state.counter < 24))
			elif transition == 2:
				return True
			else:
				raise IndexError
...
class process3Automaton(object):
	...
	def set_initial_values(self, state: State) -> None:
		state.process3_location = 0
	
	def set_initial_transient_values(self, transient: Transient) -> None:
		pass
	
	def get_transient_value(self, state: State, transient_variable: str):
		location = state.process3_location
		return None
	
	def get_transition_count(self, state: State) -> int:
		return self.transition_counts[state.process3_location]
	
	def get_transition_label(self, state: State, transition: int) -> int:
		return self.transition_labels[state.process3_location][transition]
	...
	def get_guard_value(self, state: State, transition: int) -> bool:
		...
		if location == 0:
			...
			if transition == 0:
				return ((state.coin3 == 0) and (state.counter > 0))
			elif transition == 1:
				return ((state.coin3 == 1) and (state.counter < 24))
			elif transition == 2:
				return True
			else:
				raise IndexError
	...
	def get_branch_count(self, state: State, transition: int) -> int:
		return self.branch_counts[state.process3_location][transition]
		...
		if assignment_index == -2:
			...
			if location == 0:
				if transition == 0:
					if branch == 0:
						target_transient.exit_reward_0 = (transient.exit_reward_0 - transient.steps)
						target_state.process3_location = 1
					elif branch == 1:
						target_transient.exit_reward_0 = (transient.exit_reward_0 - transient.steps)
						target_state.process3_location = 1
				elif transition == 1:
					if branch == 0:
						target_transient.exit_reward_0 = (transient.exit_reward_0 - transient.steps)
						target_state.process3_location = 0
			elif location == 1:
				if transition == 0:
					if branch == 0:
						target_transient.exit_reward_0 = (transient.exit_reward_0 - transient.steps)
						target_state.process3_location = 2
				elif transition == 1:
					if branch == 0:
						target_transient.exit_reward_0 = (transient.exit_reward_0 - transient.steps)
						target_state.process3_location = 2
				...
				if transition == 0:
					if branch == 0:
						target_transient.exit_reward_0 = (transient.exit_reward_0 - transient.steps)
						target_state.process3_location = 3
				elif transition == 1:
					if branch == 0:
						target_transient.exit_reward_0 = (transient.exit_reward_0 - transient.steps)
						target_state.process3_location = 3
...
class process4Automaton(object):
	...
	def set_initial_values(self, state: State) -> None:
		state.process4_location = 0
	
	def set_initial_transient_values(self, transient: Transient) -> None:
		pass
	
	def get_transient_value(self, state: State, transient_variable: str):
		location = state.process4_location
		return None
	
	def get_transition_count(self, state: State) -> int:
		return self.transition_counts[state.process4_location]
	
	def get_transition_label(self, state: State, transition: int) -> int:
		return self.transition_labels[state.process4_location][transition]
	...
	def get_guard_value(self, state: State, transition: int) -> bool:
		...
		if location == 0:
			...
			if transition == 0:
				return ((state.coin4 == 0) and (state.counter > 0))
			elif transition == 1:
				return ((state.coin4 == 1) and (state.counter < 24))
			elif transition == 2:
				return True
			else:
				raise IndexError
	...
	def get_branch_count(self, state: State, transition: int) -> int:
		return self.branch_counts[state.process4_location][transition]
		...
		if assignment_index == -2:
			...
			if location == 0:
				if transition == 0:
					if branch == 0:
						target_transient.exit_reward_0 = (transient.exit_reward_0 - transient.steps)
						target_state.process4_location = 1
					elif branch == 1:
						target_transient.exit_reward_0 = (transient.exit_reward_0 - transient.steps)
						target_state.process4_location = 1
				elif transition == 1:
					if branch == 0:
						target_transient.exit_reward_0 = (transient.exit_reward_0 - transient.steps)
						target_state.process4_location = 0
			elif location == 1:
				if transition == 0:
					if branch == 0:
						target_transient.exit_reward_0 = (transient.exit_reward_0 - transient.steps)
						target_state.process4_location = 2
				elif transition == 1:
					if branch == 0:
						target_transient.exit_reward_0 = (transient.exit_reward_0 - transient.steps)
						target_state.process4_location = 2
				...
				if transition == 0:
					if branch == 0:
						target_transient.exit_reward_0 = (transient.exit_reward_0 - transient.steps)
						target_state.process4_location = 3
				elif transition == 1:
					if branch == 0:
						target_transient.exit_reward_0 = (transient.exit_reward_0 - transient.steps)
						target_state.process4_location = 3
...
class Network(object):
	...
	def __init__(self):
		...
		self.variables = [
			...
			VariableInfo("process3_location", 2, "int", 0, 3),
			VariableInfo("process4_location", 3, "int", 0, 3)
		]
